...
from lib.blast import extract_blast_inf
...
tmp_output_pd = site_searcher(tmp_output_pd, tmp=tmp ,genbank_file='3_gene_seq_in_file.gb', BDS_file_out_dir='./pre_binding_dir', 
...
# blast
## get blast results using local blast
blast_results_file = '5_blast_results.xml'

## Extract interested information from blast_results
tmp_output_pd = extract_blast_inf(tmp_output_pd, tmp, blast_results_file)
